...
export const getProduct = (keyword='' , currentPage=1 , price = [ 0 , 25000 ] , category , ratings=0) => async(dispatch) => {
  try {
    ...
    let link= '/products?keyword='+keyword+'&page='+currentPage+'&price[gte]='+price[0]+'&price[lte]='+price[1]+'&avgRating[gte]='+ratings
    if(category)
    link= '/products?keyword='+keyword+'&page='+currentPage+'&price[gte]='+price[0]+'&price[lte]='+price[1]+'&category='+category+'&avgRating[gte]='+ratings
